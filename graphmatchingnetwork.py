...
def batch_block_pair_attention(data,
    ...
    # --- BULLETPROOF FIX ADDED HERE ---
    # Dynamically find the true number of graphs in this specific batch
    true_n_blocks = int(block_idx.max().item()) + 1
    
    # Override the passed argument to prevent early stopping
    n_blocks = true_n_blocks 
    # ----------------------------------
